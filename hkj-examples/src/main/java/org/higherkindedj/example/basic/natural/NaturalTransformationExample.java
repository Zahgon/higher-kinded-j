...
public class NaturalTransformationExample {
    ...
    private static void maybeToEitherExample() {
        ...
        Natural<MaybeKind.Witness, EitherKind.Witness<String>> maybeToEither = new Natural<>() {
        ...
        Kind<EitherKind.Witness<String>, Integer> eitherFromNothingKind = maybeToEither.apply(nothingKind);
    ...
    private static void listHeadExample() {
        ...
        System.out.println("List.of(\"first\", \"second\", \"third\").head -> " + MAYBE.narrow(headOfNonEmpty));
    ...
    private static void compositionExample() {
        ...
        // Maybe -> Optional
        Natural<MaybeKind.Witness, OptionalKind.Witness> maybeToOptional = new Natural<>() {
        ...
        // Optional -> List
        Natural<OptionalKind.Witness, ListKind.Witness> optionalToList = new Natural<>() {
        ...
        Natural<MaybeKind.Witness, ListKind.Witness> maybeToList = maybeToOptional.andThen(optionalToList);
