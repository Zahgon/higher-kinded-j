...
public class FreeApplicativeExample {
    ...
    private static void combineIndependentExample() {
        ...
        FreeAp<IdKind.Witness, String> combined = getName.map2(getAge, (name, age) -> name + " is " + age + " years old");
    ...
    private static void interpretationExample() {
        ...
        FreeAp<IdKind.Witness, Integer> sum = a.map2(b.map2(c, (x, y) -> x + y), (x, partial) -> x + partial);
    ...
    private static void comparisonWithFreeMonadExample() {
        ...
        FreeAp<IdKind.Witness, String> dashboard = fetchUser.map2(fetchPosts, (user, posts) -> "Dashboard: " + user + " with " + posts);
