...
@NullMarked
@EffectAlgebra
public sealed interface PaymentGatewayOp<A> permits PaymentGatewayOp.Authorise, PaymentGatewayOp.Charge, PaymentGatewayOp.Refund {
     ...
     */
    record Authorise<A>(Money amount, PaymentMethod method, Function<AuthorisationToken, A> k) implements PaymentGatewayOp<A> {
     ...
     * @param <A> the result type
     */
    record Charge<A>(Money amount, PaymentMethod method, Function<ChargeResult, A> k) implements PaymentGatewayOp<A> {
     ...
     * @param <A> the result type
     */
    record Refund<A>(TransactionId transactionId, Money amount, Function<ChargeResult, A> k) implements PaymentGatewayOp<A> {
