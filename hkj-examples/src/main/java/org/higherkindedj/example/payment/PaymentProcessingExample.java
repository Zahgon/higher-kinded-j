...
public final class PaymentProcessingExample {
     ...
     */
    private static final Customer CUSTOMER = new Customer(new CustomerId("cust-001"), "Jane Smith", "jane@example.com", new CustomerId("acc-001"), new PaymentMethod.CreditCard("4242", "VISA"));
    ...
    private static void runProductionInterpretation() {
        ...
        var interpreter = Interpreters.combine(new ProductionGatewayInterpreter(), new ProductionFraudInterpreter(), new ProductionLedgerInterpreter(), new ProductionNotificationInterpreter());
        // Interpret into IO and execute
        IO<PaymentResult> io = IOKindHelper.IO_OP.narrow(PaymentEffectsWiring.interpret(program, interpreter, Instances.monad(io())));
    ...
    private static void runTestInterpretation() {
        ...
        Id<PaymentResult> id = IdKindHelper.ID.narrow(PaymentEffectsWiring.interpret(program, interpreter, Instances.monad(id())));
