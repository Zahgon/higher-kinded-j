...
public class ResourceManagementExample {
    ...
    private static void bracketBasicExample() {
        ...
        IOPath<String> program = IOPath.bracket(// Acquire
        () -> {
        ...
        System.out.println("Before run - acquired: " + resourceAcquired.get() + ", released: " + resourceReleased.get());
        String result = program.unsafeRun();
        System.out.println("Result: " + result);
        System.out.println("After run - acquired: " + resourceAcquired.get() + ", released: " + resourceReleased.get());
        System.out.println();
    }
    ...
    private static void bracketWithExceptionExample() {
        ...
        IOPath<String> failingProgram = IOPath.bracket(// Acquire
        () -> {
            System.out.println("  [Acquire] Opening resource");
    ...
    private static void withResourceExample() {
        ...
        IOPath<String> program = IOPath.withResource(// Acquire - returns an AutoCloseable
        () -> {
            try {
    ...
    private static void guaranteeExample() {
        ...
        // Success case
        IOPath<String> successProgram = Path.io(() -> "Success!").guarantee(() -> {
        ...
        System.out.println("Result: " + result);
        // Failure case
        IOPath<String> failProgram = Path.<String>io(() -> {
    ...
    private static void nestedResourcesExample() {
        ...
        unsafeRun(), // Release outer (runs SECOND)
        outer -> {
            int order = releaseOrder.incrementAndGet();
    ...
    private static void realWorldFileExample() {
        ...
        IOPath<Integer> processProgram = IOPath.bracket(// Acquire reader
        () -> {
            try {
        ...
        }, reader -> IOPath.bracket(// Acquire writer
        () -> {
            try {
