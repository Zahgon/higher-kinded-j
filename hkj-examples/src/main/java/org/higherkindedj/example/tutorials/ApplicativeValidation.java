...
public final class ApplicativeValidation {
     ...
     * </ul>
     */
    private static final Function<String, Validated<String, String>> validateUsername = username -> {
     ...
     */
    private static final Function<String, Validated<String, String>> validateEmail = email -> {
     ...
     * </ul>
     */
    private static final Function<Integer, Validated<String, Integer>> validateAge = age -> {
        if (age < 18) {
     ...
     * Java HTML Sanitizer.
     */
    private static final Function<String, Validated<String, String>> validatePassword = password -> {
     ...
     */
    public static Either<String, UserRegistration> validateUserFailFast(String username, String email, int age, String password) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static Validated<String, UserRegistration> validateUserAccumulating(String username, String email, int age, String password) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
    ...
    private static void demonstrateValidation(String username, String email, int age, String password) {
        System.out.println("Input: " + username + ", " + email + ", " + age + ", " + password);
        // Try fail-fast validation
        Either<String, UserRegistration> failFast = validateUserFailFast(username, email, age, password);
        System.out.println("  Fail-Fast (Either): " + (failFast.isRight() ? "✓ Valid - " + failFast.getRight() : "✗ Error - " + failFast.getLeft()));
        // Try accumulating validation
        Validated<String, UserRegistration> accumulating = validateUserAccumulating(username, email, age, password);
        System.out.println("  Accumulating (Validated): " + (accumulating.isValid() ? "✓ Valid - " + accumulating.get() : "✗ Errors - " + accumulating.getError()));
    }
}
