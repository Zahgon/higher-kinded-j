...
public final class LensDeepUpdate {
    ...
    private static void demonstrateStreetNameUpdate(User original) {
        ...
        Lens<User, String> userToStreetName = UserLenses.profile().andThen(ProfileLenses.address()).andThen(AddressLenses.street()).andThen(StreetLenses.name());
    ...
    private static void demonstrateMultipleUpdates(User original) {
        ...
        Lens<User, String> userToCity = UserLenses.profile().andThen(ProfileLenses.address()).andThen(AddressLenses.city());
        Lens<User, String> userToPostalCode = UserLenses.profile().andThen(ProfileLenses.address()).andThen(AddressLenses.postalCode());
    ...
    private static void demonstrateReusableLenses(User original) {
        ...
        User updated = userToStreet.modify(street -> new Street(street.name(), street.number() + 100), original);
