...
public final class Resilience {
     ...
     */
    public static <A> EitherPath<OrderError, A> withTimeout(IOPath<A> operation, Duration timeout, String operationName) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @return an EitherPath with timeout error handling
     */
    public static <A> EitherPath<OrderError, A> withTimeout(Supplier<A> supplier, Duration timeout, String operationName) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }

    private static <A> Either<OrderError, A> executeWithTimeout(IOPath<A> operation, Duration timeout, String operationName) {
        ...
        try {
            ...
            return Either.left(OrderError.SystemError.unexpected("Operation failed: " + operationName, cause != null ? cause : e));
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
            return Either.left(OrderError.SystemError.unexpected("Operation interrupted: " + operationName, e));
        } finally {
     ...
     */
    public static <A> EitherPath<OrderError, A> resilient(IOPath<A> operation, RetryPolicy retryPolicy, Duration timeout, String operationName) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <A> EitherPath<OrderError, A> resilient(Supplier<A> operation, int maxRetries, Duration retryDelay, Duration timeout, String operationName) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
