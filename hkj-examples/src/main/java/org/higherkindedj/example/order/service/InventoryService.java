...
public interface InventoryService {
    ...
    Either<OrderError, List<ProductAvailability>> getDetailedAvailability(List<ValidatedOrderLine> lines);
    ...
    Either<OrderError, InventoryReservation> reserveAvailable(OrderId orderId, List<ProductAvailability> availability);
     ...
     */
    record InventoryCheckResult(boolean allAvailable, List<String> unavailableProducts, List<PartialStock> partialAvailability) {
