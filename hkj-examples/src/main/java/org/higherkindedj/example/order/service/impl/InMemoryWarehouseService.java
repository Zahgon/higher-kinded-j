...
public class InMemoryWarehouseService implements WarehouseService {
    ...
    public InMemoryWarehouseService() {
        ...
        warehouses.put("WAREHOUSE-UK-01", WarehouseInfo.uk("WAREHOUSE-UK-01", "UK Distribution Centre", new BigDecimal("3.99")));
        warehouses.put("WAREHOUSE-UK-02", WarehouseInfo.uk("WAREHOUSE-UK-02", "UK Secondary Warehouse", new BigDecimal("4.99")));
        warehouses.put("WAREHOUSE-EU-01", WarehouseInfo.eu("WAREHOUSE-EU-01", "EU Distribution Centre (Netherlands)", new BigDecimal("7.99")));
        warehouses.put("WAREHOUSE-INTL-01", WarehouseInfo.international("WAREHOUSE-INTL-01", "US Distribution Centre", "USA", new BigDecimal("14.99")));
    }
