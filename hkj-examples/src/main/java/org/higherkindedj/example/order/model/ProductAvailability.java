 ...
 */
public record ProductAvailability(ProductId productId, int requestedQty, int availableQty, String warehouseId) {
     ...
     */
    public static ProductAvailability partial(ProductId productId, int requestedQty, int availableQty, String warehouseId) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
