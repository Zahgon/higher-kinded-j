...
public class IxedUsageExample {
    ...
    @GenerateLenses
    public record ServerConfig(String name, Map<String, Integer> ports, Map<String, String> environment, List<String> allowedOrigins) {
    }
    ...
    private static void demonstrateLensComposition() {
        ...
        ServerConfig config = new ServerConfig("production", new HashMap<>(Map.of("http", 8080, "https", 8443, "ws", 8765)), new HashMap<>(Map.of("NODE_ENV", "production", "LOG_LEVEL", "info")), new ArrayList<>(List.of("*.example.com")));
        ...
        Traversal<ServerConfig, Integer> httpPortTraversal = portsLens.asTraversal().andThen(portIx.ix("http"));
        ...
        Traversal<ServerConfig, Integer> ftpPortTraversal = portsLens.asTraversal().andThen(portIx.ix("ftp"));
