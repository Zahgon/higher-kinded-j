...
public final class CompanyBridge {
     ...
     */
    public static final Lens<Company, String> HEADQUARTERS_CITY = CompanyFocus.headquarters().toLens().andThen(AddressOptics.city());

    /**
     * Lens from Company to headquarters postcode.
     */
    public static final Lens<Company, String> HEADQUARTERS_POSTCODE = CompanyFocus.headquarters().toLens().andThen(AddressOptics.postcode());

    /**
     * Lens from Company to headquarters country.
     */
    public static final Lens<Company, String> HEADQUARTERS_COUNTRY = CompanyFocus.headquarters().toLens().andThen(AddressOptics.country());
