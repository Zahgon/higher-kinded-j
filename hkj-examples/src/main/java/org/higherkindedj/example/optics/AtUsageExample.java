...
public class AtUsageExample {
    ...
    @GenerateLenses
    public record AUUserProfile(String username, Map<String, String> settings, Map<String, Integer> scores, List<String> tags) {
    }
    ...
    private static void demonstrateLensComposition() {
        ...
        // Initial profile
        AUUserProfile profile = new AUUserProfile("alice", new HashMap<>(Map.of("theme", "dark", "language", "en")), new HashMap<>(Map.of("math", 95)), new ArrayList<>(List.of("developer")));
        ...
        Lens<AUUserProfile, Optional<String>> notificationsLens = settingsLens.andThen(settingsAt.at("notifications"));
        ...
        Lens<AUUserProfile, Optional<String>> languageLens = settingsLens.andThen(settingsAt.at("language"));
    ...
    private static void demonstrateDeepComposition() {
        ...
        Traversal<AUUserProfile, Integer> mathScoreTraversal = mathScoreLens.asTraversal().andThen(somePrism.asTraversal());
        AUUserProfile profile = new AUUserProfile("bob", new HashMap<>(), new HashMap<>(Map.of("math", 85, "science", 90)), new ArrayList<>());
        System.out.println("Initial profile: " + profile);
        ...
        Traversal<AUUserProfile, Integer> historyScoreTraversal = scoresLens.andThen(scoresAt.at("history")).asTraversal().andThen(somePrism.asTraversal());
