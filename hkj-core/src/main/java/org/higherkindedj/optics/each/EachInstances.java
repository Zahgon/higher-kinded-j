...
public final class EachInstances {
    ...
    private static final class ArrayEach<A> implements Each<A[], A> {
        ...
        private IndexedTraversal<Integer, A[], A> createArrayIndexedTraversal() {
            return new IndexedTraversal<>() {
                ...
                @Override
                public <F extends WitnessArity<TypeArity.Unary>> Kind<F, A[]> imodifyF(BiFunction<Integer, A, Kind<F, A>> f, A[] source, Applicative<F> app) {
                    throw new UnsupportedOperationException("STUB: not implemented");
                }
            };
        }
    ...
    private static final class StringCharsTraversal implements Traversal<String, Character> {
        ...
        @Override
        public <F extends WitnessArity<TypeArity.Unary>> Kind<F, String> modifyF(Function<Character, Kind<F, Character>> f, String source, Applicative<F> app) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
    }

    private static final class StringCharsIndexedTraversal implements IndexedTraversal<Integer, String, Character> {

        @Override
        public <F extends WitnessArity<TypeArity.Unary>> Kind<F, String> imodifyF(BiFunction<Integer, Character, Kind<F, Character>> f, String source, Applicative<F> app) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
    }
     ...
     */
    public static <F extends WitnessArity<TypeArity.Unary>, A> Each<Kind<F, A>, A> fromTraverse(Traverse<F> traverse) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <C extends Iterable<A>, A> Each<C, A> fromIterableCollecting(Function<List<A>, C> collector) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <M, K, V> Each<M, V> mapValuesEachCollecting(Function<M, Map<K, V>> view, Function<Map<K, V>, M> rebuild) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <M extends Map<K, V>, K, V> Each<M, V> mapValuesEachCollecting(Function<Map<K, V>, M> collector) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
