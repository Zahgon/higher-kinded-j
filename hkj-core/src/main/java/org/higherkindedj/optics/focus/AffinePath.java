...
public sealed interface AffinePath<S, A> permits AffineFocusPath {
     ...
     */
    default <F extends WitnessArity<TypeArity.Unary>> Kind<F, S> modifyF(Function<A, Kind<F, A>> f, S source, Applicative<F> applicative) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @SuppressWarnings("unchecked")
    default <F extends WitnessArity<TypeArity.Unary>, E> TraversalPath<S, E> traverseOver(Traverse<F> traverse) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    // Intentionally working with nullable values
