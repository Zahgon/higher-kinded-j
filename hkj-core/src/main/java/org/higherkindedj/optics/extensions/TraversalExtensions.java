...
public final class TraversalExtensions {
     ...
     */
    public static <S, A> Maybe<S> modifyAllMaybe(Traversal<S, A> traversal, Function<A, Maybe<A>> f, S source) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <E, S, A> Either<E, S> modifyAllEither(Traversal<S, A> traversal, Function<A, Either<E, A>> f, S source) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <E, S, A> Validated<List<E>, S> modifyAllValidated(Traversal<S, A> traversal, Function<A, Validated<E, A>> f, S source) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <S, A> S modifyWherePossible(Traversal<S, A> traversal, Function<A, Maybe<A>> f, S source) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <E, S, A> int countValid(Traversal<S, A> traversal, Function<A, Either<E, A>> validator, S source) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <E, S, A> List<E> collectErrors(Traversal<S, A> traversal, Function<A, Either<E, A>> validator, S source) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
