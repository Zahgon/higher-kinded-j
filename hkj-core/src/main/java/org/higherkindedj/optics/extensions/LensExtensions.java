...
public final class LensExtensions {
     ...
     */
    public static <E, S, A> Either<E, S> modifyEither(Lens<S, A> lens, Function<A, Either<E, A>> f, S source) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     *     otherwise
     */
    public static <E, S, A> Validated<E, S> modifyValidated(Lens<S, A> lens, Function<A, Validated<E, A>> f, S source) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     *     otherwise
     */
    public static <S, A> Either<String, S> setIfValid(Lens<S, A> lens, Function<A, Either<String, A>> validator, A newValue, S source) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
