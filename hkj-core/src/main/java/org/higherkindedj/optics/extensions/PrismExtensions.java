...
public final class PrismExtensions {
     ...
     */
    public static <E, S, A> Either<E, S> modifyEither(Prism<S, A> prism, E noMatchError, Function<A, Either<E, A>> f, S source) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     *     otherwise
     */
    public static <E, S, A> Validated<E, S> modifyValidated(Prism<S, A> prism, E noMatchError, Function<A, Validated<E, A>> f, S source) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
