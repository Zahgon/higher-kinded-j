...
public final class OpticOps {
     ...
     */
    public static <F extends WitnessArity<TypeArity.Unary>, S, A> Kind<F, S> modifyF(S source, Lens<S, A> lens, Function<A, Kind<F, A>> modifier, Functor<F> functor) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @return The modified structure wrapped in the effect
     */
    public static <F extends WitnessArity<TypeArity.Unary>, S, A> Kind<F, S> modifyAllF(S source, Traversal<S, A> traversal, Function<A, Kind<F, A>> modifier, Applicative<F> applicative) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <E, S, A> Either<E, S> modifyEither(S source, Lens<S, A> lens, Function<A, Either<E, A>> validator) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <S, A> Maybe<S> modifyMaybe(S source, Lens<S, A> lens, Function<A, Maybe<A>> validator) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     *     errors) otherwise
     */
    public static <E, S, A> Validated<List<E>, S> modifyAllValidated(S source, Traversal<S, A> traversal, Function<A, Validated<E, A>> validator) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     *     otherwise
     */
    public static <E, S, A> Either<E, S> modifyAllEither(S source, Traversal<S, A> traversal, Function<A, Either<E, A>> validator) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
    ...
    public static final class ModifyBuilder<S> {
         ...
         * @return The modified structure wrapped in the effect
         */
        public <F extends WitnessArity<TypeArity.Unary>, A> Kind<F, S> throughF(Lens<S, A> lens, Function<A, Kind<F, A>> modifier, Functor<F> functor) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
         ...
         * @return The modified structure wrapped in the effect
         */
        public <F extends WitnessArity<TypeArity.Unary>, A> Kind<F, S> allThroughF(Traversal<S, A> traversal, Function<A, Kind<F, A>> modifier, Applicative<F> applicative) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
    }
    ...
    public static final class ModifyingWithValidation<S> {
         ...
         */
        public <E, A> Validated<List<E>, S> allThroughValidated(Traversal<S, A> traversal, Function<A, Validated<E, A>> validator) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
         ...
         */
        public <E, A> Either<E, S> allThroughEither(Traversal<S, A> traversal, Function<A, Either<E, A>> validator) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
    }
}
