...
public enum StateKindHelper implements StateConverterOps {
     ...
     */
    public <S, A> StateTuple<S, A> runState(@Nullable Kind<StateKind.Witness<S>, A> kind, S initialState) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Nullable
    public <S, A> A evalState(@Nullable Kind<StateKind.Witness<S>, A> kind, S initialState) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
