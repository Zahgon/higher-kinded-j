 ...
 */
public class FreeMonad<F extends WitnessArity<TypeArity.Unary>> extends FreeFunctor<F> implements Monad<FreeKind.Witness<F>> {
     ...
     */
    @Override
    public <A, B> Kind<FreeKind.Witness<F>, B> flatMap(Function<? super A, ? extends Kind<FreeKind.Witness<F>, B>> f, Kind<FreeKind.Witness<F>, A> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B> Kind<FreeKind.Witness<F>, B> ap(Kind<FreeKind.Witness<F>, ? extends Function<A, B>> ff, Kind<FreeKind.Witness<F>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
