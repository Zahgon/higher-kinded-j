...
public class StreamMonad implements MonadZero<StreamKind.Witness> {
     ...
     */
    @Override
    public <A, B> Kind<StreamKind.Witness, B> ap(Kind<StreamKind.Witness, ? extends Function<A, B>> ff, Kind<StreamKind.Witness, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B> Kind<StreamKind.Witness, B> flatMap(Function<? super A, ? extends Kind<StreamKind.Witness, B>> f, Kind<StreamKind.Witness, A> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A> Kind<StreamKind.Witness, A> filter(Predicate<? super A> predicate, Kind<StreamKind.Witness, A> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A> Kind<StreamKind.Witness, A> orElse(Kind<StreamKind.Witness, A> sa, Supplier<Kind<StreamKind.Witness, A>> sb) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A> Kind<StreamKind.Witness, A> orElseAll(Iterable<Kind<StreamKind.Witness, A>> alternatives) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
