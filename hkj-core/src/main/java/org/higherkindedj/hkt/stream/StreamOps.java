...
public final class StreamOps {
     ...
     */
    public static <A> Kind<StreamKind.Witness, A> filter(Predicate<? super A> predicate, Kind<StreamKind.Witness, A> stream) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <A> Kind<StreamKind.Witness, A> concat(Kind<StreamKind.Witness, A> s1, Kind<StreamKind.Witness, A> s2) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <A, B, C> Kind<StreamKind.Witness, C> zip(Kind<StreamKind.Witness, A> sa, Kind<StreamKind.Witness, B> sb, BiFunction<? super A, ? super B, ? extends C> zipper) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     *
     * <p><b>Warning:</b> This implementation uses a stateful function and is <b>not safe</b> for use
     * with parallel streams. It will produce non-deterministic and incorrect indices if the stream is
     * parallel. It should only be used with sequential streams. The operation is lazy for sequential
     * streams.
     *
     * <p><b>Example:</b>
     *
     ...
     * @throws NullPointerException if stream is null.
     */
    public static <A> Kind<StreamKind.Witness, Tuple2<Integer, A>> zipWithIndex(Kind<StreamKind.Witness, A> stream) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <A> Kind<StreamKind.Witness, A> tap(Consumer<? super A> action, Kind<StreamKind.Witness, A> stream) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
