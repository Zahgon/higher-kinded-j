 ...
 */
@NullMarked
public sealed interface StateOp<S, A> permits StateOp.View, StateOp.Over, StateOp.Assign, StateOp.Preview, StateOp.TraverseOver, StateOp.GetState {
     ...
     * @param <A> The mapped result type (HKT carrier)
     */
    record Over<S, R, A>(Lens<S, R> optic, Function<R, R> f, Function<R, A> k) implements StateOp<S, A> {
     ...
     * @param <A> The mapped result type (HKT carrier)
     */
    record TraverseOver<S, R, A>(Traversal<S, R> optic, Function<R, R> f, Function<S, A> k) implements StateOp<S, A> {
