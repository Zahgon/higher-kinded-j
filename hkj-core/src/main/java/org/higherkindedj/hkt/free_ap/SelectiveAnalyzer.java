...
public interface SelectiveAnalyzer {
     ...
     */
    public static <F extends WitnessArity<TypeArity.Unary>, A, Op> Set<Op> collectPossibleEffects(FreeAp<F, A> program, Function<Kind<F, ?>, Op> narrow) {
     ...
     */
    public static <F extends WitnessArity<TypeArity.Unary>, A> int countMaximumEffects(FreeAp<F, A> program) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @throws NullPointerException if program is null
     */
    public static <F extends WitnessArity<TypeArity.Unary>, A> EffectBounds computeEffectBounds(FreeAp<F, A> program) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @throws NullPointerException if any argument is null
     */
    public static <F extends WitnessArity<TypeArity.Unary>, A, Op> EffectPartition<Op> partitionEffects(FreeAp<F, A> program, Function<Kind<F, ?>, Op> narrow) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @throws NullPointerException if any argument is null
     */
    public static <F extends WitnessArity<TypeArity.Unary>, A, Op> boolean containsDangerousEffect(FreeAp<F, A> program, Function<Kind<F, ?>, Op> narrow, Predicate<Op> isDangerous) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
