 ...
 */
public class FreeApApplicative<F extends WitnessArity<TypeArity.Unary>> extends FreeApFunctor<F> implements Applicative<FreeApKind.Witness<F>> {
     ...
     */
    @Override
    public <A, B> Kind<FreeApKind.Witness<F>, B> ap(Kind<FreeApKind.Witness<F>, ? extends Function<A, B>> ff, Kind<FreeApKind.Witness<F>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B, C> Kind<FreeApKind.Witness<F>, C> map2(Kind<FreeApKind.Witness<F>, A> fa, Kind<FreeApKind.Witness<F>, B> fb, BiFunction<? super A, ? super B, ? extends C> f) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
