...
public final class ConstApplicative<M> implements Applicative<ConstKind.Witness<M>> {
    ...
    public <A, B> Kind<ConstKind.Witness<M>, B> map(Function<? super A, ? extends B> f, Kind<ConstKind.Witness<M>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
    ...
    @Override
    @SuppressWarnings("unchecked")
    public <A, B> Kind<ConstKind.Witness<M>, B> ap(Kind<ConstKind.Witness<M>, ? extends Function<A, B>> ff, Kind<ConstKind.Witness<M>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
    ...
    @Override
    @SuppressWarnings("unchecked")
    public <A, B, C> Kind<ConstKind.Witness<M>, C> map2(Kind<ConstKind.Witness<M>, A> fa, Kind<ConstKind.Witness<M>, B> fb, BiFunction<? super A, ? super B, ? extends C> f) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
