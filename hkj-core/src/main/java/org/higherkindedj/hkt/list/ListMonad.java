...
public class ListMonad implements MonadZero<ListKind.Witness> {
     ...
     */
    @Override
    public <A, B> Kind<ListKind.Witness, B> ap(Kind<ListKind.Witness, ? extends Function<A, B>> ff, Kind<ListKind.Witness, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B> Kind<ListKind.Witness, B> flatMap(Function<? super A, ? extends Kind<ListKind.Witness, B>> f, Kind<ListKind.Witness, A> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A> Kind<ListKind.Witness, A> filter(Predicate<? super A> predicate, Kind<ListKind.Witness, A> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A> Kind<ListKind.Witness, A> orElse(Kind<ListKind.Witness, A> la, Supplier<Kind<ListKind.Witness, A>> lb) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
