...
public final class ListSelective extends ListMonad implements Selective<ListKind.Witness> {
     ...
     */
    @Override
    public <A, B> Kind<ListKind.Witness, B> select(Kind<ListKind.Witness, Choice<A, B>> fab, Kind<ListKind.Witness, Function<A, B>> ff) {
     ...
     */
    @Override
    public <A, B, C> Kind<ListKind.Witness, C> branch(Kind<ListKind.Witness, Choice<A, B>> fab, Kind<ListKind.Witness, Function<A, C>> fl, Kind<ListKind.Witness, Function<B, C>> fr) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public Kind<ListKind.Witness, Unit> whenS(Kind<ListKind.Witness, Boolean> fcond, Kind<ListKind.Witness, Unit> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A> Kind<ListKind.Witness, A> ifS(Kind<ListKind.Witness, Boolean> fcond, Kind<ListKind.Witness, A> fthen, Kind<ListKind.Witness, A> felse) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
