...
public record Writer<W, A>(W log, @Nullable A value) {
     ...
     */
    public <W2, B> Writer<W2, B> bimap(Function<? super W, ? extends W2> logMapper, Function<? super A, ? extends B> valueMapper) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <B> Writer<W, B> flatMap(Monoid<W> monoidW, Function<? super A, ? extends Writer<W, ? extends B>> f) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
