...
public enum EitherFKindHelper {
     ...
     */
    record EitherFHolder<F extends WitnessArity<?>, G extends WitnessArity<?>, A>(EitherF<F, G, A> value) implements EitherFKind<F, G, A> {
    }
     ...
     */
    public <F extends WitnessArity<?>, G extends WitnessArity<?>, A> Kind<EitherFKind.Witness<F, G>, A> widen(EitherF<F, G, A> eitherF) {
    ...
    public <F extends WitnessArity<?>, G extends WitnessArity<?>, A> EitherF<F, G, A> narrow(Kind<EitherFKind.Witness<F, G>, A> kind) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
