...
public final class Interpreters {
     ...
     */
    public static <F extends WitnessArity<?>, G extends WitnessArity<?>, M extends WitnessArity<?>> Natural<EitherFKind.Witness<F, G>, M> combine(Natural<F, M> interpF, Natural<G, M> interpG) {
     ...
     */
    public static <F extends WitnessArity<?>, G extends WitnessArity<?>, H extends WitnessArity<?>, M extends WitnessArity<?>> Natural<EitherFKind.Witness<F, EitherFKind.Witness<G, H>>, M> combine(Natural<F, M> interpF, Natural<G, M> interpG, Natural<H, M> interpH) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static <F extends WitnessArity<?>, G extends WitnessArity<?>, H extends WitnessArity<?>, I extends WitnessArity<?>, M extends WitnessArity<?>> Natural<EitherFKind.Witness<F, EitherFKind.Witness<G, EitherFKind.Witness<H, I>>>, M> combine(Natural<F, M> interpF, Natural<G, M> interpG, Natural<H, M> interpH, Natural<I, M> interpI) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
