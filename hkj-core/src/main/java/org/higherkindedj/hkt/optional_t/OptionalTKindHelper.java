...
public enum OptionalTKindHelper implements OptionalTConverterOps {
     ...
     */
    @Override
    public <F extends WitnessArity<TypeArity.Unary>, A> Kind<OptionalTKind.Witness<F>, A> widen(OptionalT<F, A> optionalT) {
     ...
     */
    @Override
    public <F extends WitnessArity<TypeArity.Unary>, A> OptionalT<F, A> narrow(@Nullable Kind<OptionalTKind.Witness<F>, A> kind) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
