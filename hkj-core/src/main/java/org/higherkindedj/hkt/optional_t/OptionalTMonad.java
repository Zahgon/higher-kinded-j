 ...
 */
public class OptionalTMonad<F extends WitnessArity<TypeArity.Unary>> implements MonadError<OptionalTKind.Witness<F>, Unit> {
    ...
    public OptionalTMonad(Monad<F> outerMonad) {
        this.outerMonad = Validation.transformer().requireOuterMonad(outerMonad, OPTIONAL_T_MONAD_CLASS, CONSTRUCTION);
    }
     ...
     */
    @Override
    public <A, B> Kind<OptionalTKind.Witness<F>, B> map(Function<? super A, ? extends @Nullable B> f, Kind<OptionalTKind.Witness<F>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B> Kind<OptionalTKind.Witness<F>, B> ap(Kind<OptionalTKind.Witness<F>, ? extends Function<A, @Nullable B>> ff, Kind<OptionalTKind.Witness<F>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B> Kind<OptionalTKind.Witness<F>, B> flatMap(Function<? super A, ? extends Kind<OptionalTKind.Witness<F>, B>> f, Kind<OptionalTKind.Witness<F>, A> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A> Kind<OptionalTKind.Witness<F>, A> handleErrorWith(Kind<OptionalTKind.Witness<F>, A> ma, Function<? super Unit, ? extends Kind<OptionalTKind.Witness<F>, A>> handler) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
