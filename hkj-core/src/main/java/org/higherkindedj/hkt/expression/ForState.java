 ...
 *   <li><b>State zooming:</b> Temporarily narrow state scope via {@code zoom()} / {@code
 *       endZoom()}. Zoom accepts a plain {@link Lens}, a {@link FocusPath} produced by
 *       {@code @GenerateFocus}, or an {@link Iso} for representation-change zoom. On {@link
 *       FilterableSteps}, {@link AffinePath} is also supported and short-circuits via {@link
