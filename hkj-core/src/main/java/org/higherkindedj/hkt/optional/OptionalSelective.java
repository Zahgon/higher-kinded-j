 ...
 * @see Unit
 */
public final class OptionalSelective extends OptionalMonad implements Selective<OptionalKind.Witness> {
     ...
     */
    @Override
    public <A, B> Kind<OptionalKind.Witness, B> select(Kind<OptionalKind.Witness, Choice<A, B>> fab, Kind<OptionalKind.Witness, Function<A, B>> ff) {
     ...
     */
    @Override
    public <A, B, C> Kind<OptionalKind.Witness, C> branch(Kind<OptionalKind.Witness, Choice<A, B>> fab, Kind<OptionalKind.Witness, Function<A, C>> fl, Kind<OptionalKind.Witness, Function<B, C>> fr) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public Kind<OptionalKind.Witness, Unit> whenS(Kind<OptionalKind.Witness, Boolean> fcond, Kind<OptionalKind.Witness, Unit> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A> Kind<OptionalKind.Witness, A> ifS(Kind<OptionalKind.Witness, Boolean> fcond, Kind<OptionalKind.Witness, A> fthen, Kind<OptionalKind.Witness, A> felse) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
