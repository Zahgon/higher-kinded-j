 ...
 */
public record MaybeT<F extends WitnessArity<TypeArity.Unary>, A>(Kind<F, Maybe<A>> value) implements MaybeTKind<F, A> {
     ...
     * @throws NullPointerException if {@code value} is null.
     */
    public static <F extends WitnessArity<TypeArity.Unary>, A> MaybeT<F, A> fromKind(Kind<F, Maybe<A>> value) {
     ...
     */
    public static <F extends WitnessArity<TypeArity.Unary>, A extends Object> MaybeT<F, A> just(Monad<F> outerMonad, A a) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <G extends WitnessArity<TypeArity.Unary>> MaybeT<G, A> mapT(Function<Kind<F, Maybe<A>>, Kind<G, Maybe<A>>> f) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
