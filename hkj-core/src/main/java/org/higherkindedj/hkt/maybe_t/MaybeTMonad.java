 ...
 */
public class MaybeTMonad<F extends WitnessArity<TypeArity.Unary>> implements MonadError<MaybeTKind.Witness<F>, Unit> {
    ...
    public MaybeTMonad(Monad<F> outerMonad) {
        this.outerMonad = Validation.transformer().requireOuterMonad(outerMonad, MAYBE_T_MONAD_CLASS, CONSTRUCTION);
    }
     ...
     */
    @Override
    public <A, B> Kind<MaybeTKind.Witness<F>, B> map(Function<? super A, ? extends B> f, Kind<MaybeTKind.Witness<F>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B> Kind<MaybeTKind.Witness<F>, B> ap(Kind<MaybeTKind.Witness<F>, ? extends Function<A, B>> ff, Kind<MaybeTKind.Witness<F>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B> Kind<MaybeTKind.Witness<F>, B> flatMap(Function<? super A, ? extends Kind<MaybeTKind.Witness<F>, B>> f, Kind<MaybeTKind.Witness<F>, A> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A> Kind<MaybeTKind.Witness<F>, A> handleErrorWith(Kind<MaybeTKind.Witness<F>, A> ma, Function<? super Unit, ? extends Kind<MaybeTKind.Witness<F>, A>> handler) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
