...
public enum TryTraverse implements Traverse<TryKind.Witness> {
     ...
     */
    @Override
    public <G extends WitnessArity<TypeArity.Unary>, A, B> Kind<G, Kind<TryKind.Witness, B>> traverse(Applicative<G> applicative, Function<? super A, ? extends Kind<G, ? extends B>> f, Kind<TryKind.Witness, A> ta) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, M> M foldMap(Monoid<M> monoid, Function<? super A, ? extends M> f, Kind<TryKind.Witness, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
