 ...
 */
public class ReaderApplicative<R> extends ReaderFunctor<R> implements Applicative<ReaderKind.Witness<R>> {
     ...
     */
    @Override
    public <A, B> Kind<ReaderKind.Witness<R>, B> ap(Kind<ReaderKind.Witness<R>, ? extends Function<A, B>> ff, Kind<ReaderKind.Witness<R>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
