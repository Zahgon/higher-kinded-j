 ...
 * @see Choice
 */
public final class ReaderSelective<R> extends ReaderMonad<R> implements Selective<ReaderKind.Witness<R>> {
     ...
     */
    @Override
    public <A, B> Kind<ReaderKind.Witness<R>, B> select(Kind<ReaderKind.Witness<R>, Choice<A, B>> fab, Kind<ReaderKind.Witness<R>, Function<A, B>> ff) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B, C> Kind<ReaderKind.Witness<R>, C> branch(Kind<ReaderKind.Witness<R>, Choice<A, B>> fab, Kind<ReaderKind.Witness<R>, Function<A, C>> fl, Kind<ReaderKind.Witness<R>, Function<B, C>> fr) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public Kind<ReaderKind.Witness<R>, Unit> whenS(Kind<ReaderKind.Witness<R>, Boolean> fcond, Kind<ReaderKind.Witness<R>, Unit> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A> Kind<ReaderKind.Witness<R>, A> ifS(Kind<ReaderKind.Witness<R>, Boolean> fcond, Kind<ReaderKind.Witness<R>, A> fthen, Kind<ReaderKind.Witness<R>, A> felse) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
