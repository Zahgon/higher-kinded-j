...
public enum StateTKindHelper implements StateTConverterOps {
     ...
     */
    @Override
    public <S, F extends WitnessArity<TypeArity.Unary>, A> Kind<StateTKind.Witness<S, F>, A> widen(StateT<S, F, A> stateT) {
     ...
     */
    @Override
    public <S, F extends WitnessArity<TypeArity.Unary>, A> StateT<S, F, A> narrow(@Nullable Kind<StateTKind.Witness<S, F>, A> kind) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <S, F extends WitnessArity<TypeArity.Unary>, A> StateT<S, F, A> stateT(Function<S, Kind<F, StateTuple<S, A>>> runStateTFn, Monad<F> monadF) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <S, F extends WitnessArity<TypeArity.Unary>, A> StateT<S, F, A> liftF(Monad<F> monadF, Kind<F, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <S, F extends WitnessArity<TypeArity.Unary>, A> Kind<F, StateTuple<S, A>> runStateT(Kind<StateTKind.Witness<S, F>, A> kind, S initialState) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @throws NullPointerException if {@code kind} is null.
     */
    public <S, F extends WitnessArity<TypeArity.Unary>, A> Kind<F, A> evalStateT(Kind<StateTKind.Witness<S, F>, A> kind, S initialState) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @throws NullPointerException if {@code kind} is null.
     */
    public <S, F extends WitnessArity<TypeArity.Unary>, A> Kind<F, S> execStateT(Kind<StateTKind.Witness<S, F>, A> kind, S initialState) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
