 ...
 */
public record StateT<S, F extends WitnessArity<TypeArity.Unary>, A>(Function<S, Kind<F, StateTuple<S, A>>> runStateTFn, Monad<F> monadF) implements StateTKind<S, F, A> {
     ...
     */
    public static <S, F extends WitnessArity<TypeArity.Unary>, A> StateT<S, F, A> create(Function<S, Kind<F, StateTuple<S, A>>> runStateTFn, Monad<F> monadF) {
     ...
     */
    public <G extends WitnessArity<TypeArity.Unary>> StateT<S, G, A> mapT(Monad<G> monadG, Function<Kind<F, StateTuple<S, A>>, Kind<G, StateTuple<S, A>>> f) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
