 ...
 * @see Monad
 */
public class StateTMonad<S, F extends WitnessArity<TypeArity.Unary>> implements Monad<StateTKind.Witness<S, F>> {
    ...
    protected StateTMonad(Monad<F> monadF) {
        this.monadF = Validation.transformer().requireOuterMonad(monadF, STATE_T_MONAD_CLASS, CONSTRUCTION);
    }
     ...
     * @throws NullPointerException if {@code monadF} is null.
     */
    public static <S, F extends WitnessArity<TypeArity.Unary>> StateTMonad<S, F> instance(Monad<F> monadF) {
     ...
     */
    @Override
    public <A, B> Kind<StateTKind.Witness<S, F>, B> map(Function<? super A, ? extends B> f, Kind<StateTKind.Witness<S, F>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B> Kind<StateTKind.Witness<S, F>, B> ap(Kind<StateTKind.Witness<S, F>, ? extends Function<A, B>> ff, Kind<StateTKind.Witness<S, F>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B> Kind<StateTKind.Witness<S, F>, B> flatMap(Function<? super A, ? extends Kind<StateTKind.Witness<S, F>, B>> f, Kind<StateTKind.Witness<S, F>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
