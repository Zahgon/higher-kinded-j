 ...
 * @see VTaskKindHelper
 */
public class VTaskMonad extends VTaskApplicative implements MonadError<VTaskKind.Witness, Throwable> {
     ...
     */
    @Override
    public <A, B> Kind<VTaskKind.Witness, B> flatMap(Function<? super A, ? extends Kind<VTaskKind.Witness, B>> f, Kind<VTaskKind.Witness, A> ma) {
     ...
     */
    @Override
    public <A> Kind<VTaskKind.Witness, A> handleErrorWith(Kind<VTaskKind.Witness, A> ma, Function<? super Throwable, ? extends Kind<VTaskKind.Witness, A>> handler) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
