...
public final class OptionalContext<F extends WitnessArity<TypeArity.Unary>, A> implements EffectContext<F, A> {
     ...
     */
    public <B> OptionalContext<F, B> flatMap(Function<? super A, ? extends OptionalContext<F, B>> fn) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public OptionalContext<F, A> recoverWith(Function<? super Unit, ? extends OptionalContext<F, A>> recovery) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
