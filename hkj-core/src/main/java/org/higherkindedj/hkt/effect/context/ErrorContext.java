 ...
 */
public final class ErrorContext<F extends WitnessArity<TypeArity.Unary>, E, A> implements EffectContext<F, A> {
     ...
     */
    public static <E, A> ErrorContext<IOKind.Witness, E, A> io(ThrowableSupplier<A> computation, Function<? super Throwable, ? extends E> errorMapper) {
     ...
     */
    public static <E, A> ErrorContext<IOKind.Witness, E, A> ioEither(Supplier<Either<E, A>> computation) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <B> ErrorContext<F, E, B> flatMap(Function<? super A, ? extends ErrorContext<F, E, B>> fn) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public ErrorContext<F, E, A> recoverWith(Function<? super E, ? extends ErrorContext<F, E, A>> recovery) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
