...
public sealed interface VStreamPath<A> extends Chainable<A> permits DefaultVStreamPath {
    ...
    @Override
    <B, C> VStreamPath<C> zipWith(Combinable<B> other, BiFunction<? super A, ? super B, ? extends C> combiner);
     ...
     */
    <B, C, D> VStreamPath<D> zipWith3(VStreamPath<B> second, VStreamPath<C> third, Function3<? super A, ? super B, ? super C, ? extends D> combiner);
