 ...
 */
public final class JavaOptionalContext<F extends WitnessArity<TypeArity.Unary>, A> implements EffectContext<F, A> {
     ...
     * @throws NullPointerException if supplier is null
     */
    public static <A> JavaOptionalContext<IOKind.Witness, A> ioOptional(Supplier<Optional<A>> supplier) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <B> JavaOptionalContext<F, B> flatMap(Function<? super A, ? extends JavaOptionalContext<F, B>> fn) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <B> JavaOptionalContext<F, B> then(Supplier<? extends JavaOptionalContext<F, B>> supplier) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public JavaOptionalContext<F, A> recoverWith(Function<? super Unit, ? extends JavaOptionalContext<F, A>> recovery) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public JavaOptionalContext<F, A> orElse(Supplier<? extends JavaOptionalContext<F, A>> alternative) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
