...
public final class OptionalPath<A> implements Chainable<A> {
    ...
    @Override
    public <B, C> OptionalPath<C> zipWith(Combinable<B> other, BiFunction<? super A, ? super B, ? extends C> combiner) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <B, C, D> OptionalPath<D> zipWith3(OptionalPath<B> second, OptionalPath<C> third, Function3<? super A, ? super B, ? super C, ? extends D> combiner) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
