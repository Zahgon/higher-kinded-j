...
public final class WriterPath<W, A> implements Chainable<A> {
    ...
    @Override
    public <B, C> WriterPath<W, C> zipWith(Combinable<B> other, BiFunction<? super A, ? super B, ? extends C> combiner) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <B, C, D> WriterPath<W, D> zipWith3(WriterPath<W, B> second, WriterPath<W, C> third, Function3<? super A, ? super B, ? super C, ? extends D> combiner) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
