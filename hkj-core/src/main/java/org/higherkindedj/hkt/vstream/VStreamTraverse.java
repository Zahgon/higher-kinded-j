...
public enum VStreamTraverse implements Traverse<VStreamKind.Witness> {
     ...
     */
    @Override
    public <A, B> Kind<VStreamKind.Witness, B> map(Function<? super A, ? extends B> f, Kind<VStreamKind.Witness, A> fa) {
     ...
     */
    @Override
    public <G extends WitnessArity<TypeArity.Unary>, A, B> Kind<G, Kind<VStreamKind.Witness, B>> traverse(Applicative<G> applicative, Function<? super A, ? extends Kind<G, ? extends B>> f, Kind<VStreamKind.Witness, A> ta) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, M> M foldMap(Monoid<M> monoid, Function<? super A, ? extends M> f, Kind<VStreamKind.Witness, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
