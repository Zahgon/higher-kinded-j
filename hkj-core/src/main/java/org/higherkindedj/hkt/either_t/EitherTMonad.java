 ...
 */
public class EitherTMonad<F extends WitnessArity<TypeArity.Unary>, L> implements MonadError<EitherTKind.Witness<F, L>, L> {
    ...
    public EitherTMonad(Monad<F> outerMonad) {
        this.outerMonad = Validation.transformer().requireOuterMonad(outerMonad, EITHER_T_MONAD_CLASS, CONSTRUCTION);
    }
     ...
     */
    @Override
    public <R_IN, R_OUT> Kind<EitherTKind.Witness<F, L>, R_OUT> map(Function<? super R_IN, ? extends R_OUT> f, Kind<EitherTKind.Witness<F, L>, R_IN> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <R_IN, R_OUT> Kind<EitherTKind.Witness<F, L>, R_OUT> ap(Kind<EitherTKind.Witness<F, L>, ? extends Function<R_IN, R_OUT>> ff, Kind<EitherTKind.Witness<F, L>, R_IN> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <R_IN, R_OUT> Kind<EitherTKind.Witness<F, L>, R_OUT> flatMap(Function<? super R_IN, ? extends Kind<EitherTKind.Witness<F, L>, R_OUT>> f, Kind<EitherTKind.Witness<F, L>, R_IN> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <R> Kind<EitherTKind.Witness<F, L>, R> handleErrorWith(Kind<EitherTKind.Witness<F, L>, R> ma, Function<? super L, ? extends Kind<EitherTKind.Witness<F, L>, R>> handler) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
