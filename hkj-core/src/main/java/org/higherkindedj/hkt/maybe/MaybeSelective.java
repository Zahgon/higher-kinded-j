...
public final class MaybeSelective extends MaybeMonad implements Selective<MaybeKind.Witness> {
     ...
     */
    @Override
    public <A, B> Kind<MaybeKind.Witness, B> select(Kind<MaybeKind.Witness, Choice<A, B>> fab, Kind<MaybeKind.Witness, Function<A, B>> ff) {
     ...
     */
    @Override
    public <A, B, C> Kind<MaybeKind.Witness, C> branch(Kind<MaybeKind.Witness, Choice<A, B>> fab, Kind<MaybeKind.Witness, Function<A, C>> fl, Kind<MaybeKind.Witness, Function<B, C>> fr) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public Kind<MaybeKind.Witness, Unit> whenS(Kind<MaybeKind.Witness, Boolean> fcond, Kind<MaybeKind.Witness, Unit> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A> Kind<MaybeKind.Witness, A> ifS(Kind<MaybeKind.Witness, Boolean> fcond, Kind<MaybeKind.Witness, A> fthen, Kind<MaybeKind.Witness, A> felse) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
