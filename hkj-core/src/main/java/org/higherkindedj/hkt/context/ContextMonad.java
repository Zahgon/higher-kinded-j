 ...
 */
public class ContextMonad<R> extends ContextApplicative<R> implements Monad<ContextKind.Witness<R>> {
     ...
     */
    @Override
    public <A, B> Kind<ContextKind.Witness<R>, B> flatMap(Function<? super A, ? extends Kind<ContextKind.Witness<R>, B>> f, Kind<ContextKind.Witness<R>, A> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
