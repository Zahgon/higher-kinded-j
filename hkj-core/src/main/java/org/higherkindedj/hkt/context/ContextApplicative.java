 ...
 */
public class ContextApplicative<R> extends ContextFunctor<R> implements Applicative<ContextKind.Witness<R>> {
     ...
     */
    @Override
    public <A, B> Kind<ContextKind.Witness<R>, B> ap(Kind<ContextKind.Witness<R>, ? extends Function<A, B>> ff, Kind<ContextKind.Witness<R>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
