...
public enum ReaderTKindHelper implements ReaderTConverterOps {
     ...
     */
    @Override
    public <F extends WitnessArity<TypeArity.Unary>, R_ENV, A> Kind<ReaderTKind.Witness<F, R_ENV>, A> widen(ReaderT<F, R_ENV, A> readerT) {
     ...
     */
    @Override
    public <F extends WitnessArity<TypeArity.Unary>, R_ENV, A> ReaderT<F, R_ENV, A> narrow(@Nullable Kind<ReaderTKind.Witness<F, R_ENV>, A> kind) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
