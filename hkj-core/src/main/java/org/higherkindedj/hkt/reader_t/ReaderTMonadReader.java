 ...
 * @see ReaderT
 */
public class ReaderTMonadReader<F extends WitnessArity<TypeArity.Unary>, R_ENV> extends ReaderTMonad<F, R_ENV> implements MonadReader<ReaderTKind.Witness<F, R_ENV>, R_ENV> {
     ...
     */
    @Override
    public <A> Kind<ReaderTKind.Witness<F, R_ENV>, A> local(Function<R_ENV, R_ENV> f, Kind<ReaderTKind.Witness<F, R_ENV>, A> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
