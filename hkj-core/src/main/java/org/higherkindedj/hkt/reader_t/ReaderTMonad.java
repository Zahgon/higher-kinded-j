 ...
 */
public class ReaderTMonad<F extends WitnessArity<TypeArity.Unary>, R_ENV> implements Monad<ReaderTKind.Witness<F, R_ENV>> {
    ...
    public ReaderTMonad(Monad<F> outerMonad) {
        this.outerMonad = Validation.transformer().requireOuterMonad(outerMonad, READER_T_MONAD_CLASS, CONSTRUCTION);
    }
     ...
     */
    @Override
    public <A, B> Kind<ReaderTKind.Witness<F, R_ENV>, B> ap(Kind<ReaderTKind.Witness<F, R_ENV>, ? extends Function<A, B>> ff, Kind<ReaderTKind.Witness<F, R_ENV>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B> Kind<ReaderTKind.Witness<F, R_ENV>, B> map(Function<? super A, ? extends B> f, Kind<ReaderTKind.Witness<F, R_ENV>, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B> Kind<ReaderTKind.Witness<F, R_ENV>, B> flatMap(Function<? super A, ? extends Kind<ReaderTKind.Witness<F, R_ENV>, B>> f, Kind<ReaderTKind.Witness<F, R_ENV>, A> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
