 ...
 */
public class CompletableFutureMonad extends CompletableFutureApplicative implements MonadError<CompletableFutureKind.Witness, Throwable> {

    public static Class<CompletableFutureMonad> COMPLETABLE_FUTURE_MONAD_CLASS = CompletableFutureMonad.class;
     ...
     */
    @Override
    public <A, B> Kind<CompletableFutureKind.Witness, B> flatMap(Function<? super @Nullable A, ? extends Kind<CompletableFutureKind.Witness, B>> f, Kind<CompletableFutureKind.Witness, A> ma) {
     ...
     */
    @Override
    public <A> Kind<CompletableFutureKind.Witness, A> handleErrorWith(Kind<CompletableFutureKind.Witness, A> ma, Function<? super Throwable, ? extends Kind<CompletableFutureKind.Witness, A>> handler) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
