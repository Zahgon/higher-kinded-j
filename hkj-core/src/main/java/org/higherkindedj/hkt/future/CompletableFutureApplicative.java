 ...
 */
public class CompletableFutureApplicative extends CompletableFutureFunctor implements Applicative<CompletableFutureKind.Witness> {
     ...
     */
    @Override
    public <A, B> Kind<CompletableFutureKind.Witness, B> ap(Kind<CompletableFutureKind.Witness, ? extends Function<A, B>> ff, Kind<CompletableFutureKind.Witness, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
