 ...
 * @see LazyKindHelper
 */
public class LazyMonad implements Monad<LazyKind.Witness>, Applicative<LazyKind.Witness>, Functor<LazyKind.Witness> {
     ...
     */
    @Override
    public <A, B> Kind<LazyKind.Witness, B> map(Function<? super A, ? extends B> f, Kind<LazyKind.Witness, A> fa) {
     ...
     */
    @Override
    public <A, B> Kind<LazyKind.Witness, B> ap(Kind<LazyKind.Witness, ? extends Function<A, B>> ff, Kind<LazyKind.Witness, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public <A, B> Kind<LazyKind.Witness, B> flatMap(Function<? super A, ? extends Kind<LazyKind.Witness, B>> f, Kind<LazyKind.Witness, A> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
