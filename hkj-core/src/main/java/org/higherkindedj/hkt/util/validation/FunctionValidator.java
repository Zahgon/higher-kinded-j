...
public enum FunctionValidator {
     ...
     */
    public <F extends WitnessArity<?>, A, B> void validateMap(Function<? super A, ? extends B> f, Kind<F, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <F extends WitnessArity<?>, A, B> void validateFlatMap(Function<? super A, ? extends Kind<F, B>> f, Kind<F, A> ma) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <G extends WitnessArity<TypeArity.Unary>, A, B> void validateTraverse(Applicative<G> applicative, Function<? super A, ? extends Kind<G, ? extends B>> f, Kind<?, A> ta) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @throws NullPointerException if any parameter is null
     */
    public <M, A> void validateFoldMap(Monoid<M> monoid, Function<? super A, ? extends M> f, Kind<?, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <F extends WitnessArity<?>, A, E> void validateHandleErrorWith(Kind<F, A> ma, Function<? super E, ? extends Kind<F, A>> handler) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
