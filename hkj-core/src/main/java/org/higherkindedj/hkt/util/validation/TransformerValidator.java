...
public enum TransformerValidator {
     ...
     * </pre>
     */
    public <F extends WitnessArity<TypeArity.Unary>> Monad<F> requireOuterMonad(Monad<F> monad, Class<?> transformerClass, Operation operation) {
     ...
     */
    public <F extends WitnessArity<TypeArity.Unary>> Applicative<F> requireOuterApplicative(Applicative<F> applicative, Class<?> transformerClass, Operation operation) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <F extends WitnessArity<TypeArity.Unary>> Functor<F> requireOuterFunctor(Functor<F> functor, Class<?> transformerClass, Operation operation) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * </pre>
     */
    public <T> T requireTransformerComponent(T component, String componentName, Class<?> transformerClass, Operation operation) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
