...
public enum KindValidator {
     ...
     */
    public <F extends WitnessArity<?>, A, T> T narrow(@Nullable Kind<F, A> kind, Class<T> targetType, Function<? super Kind<F, A>, ? extends T> narrower) {
     ...
     */
    public <F extends WitnessArity<?>, A, T> T narrowWithTypeCheck(@Nullable Kind<F, A> kind, Class<T> targetType) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <F extends WitnessArity<?>, A, T, H extends Kind<F, A>> T narrowHolder(@Nullable Kind<F, A> kind, Class<T> targetType, Class<H> holderType, Function<? super H, ? extends T> accessor) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
    ...
    public <F extends WitnessArity<?>, A, T, H extends Kind<F, A>> T narrowWithPattern(@Nullable Kind<F, A> kind, Class<T> targetType, Class<H> holderType, Function<? super H, ? extends T> extractor) {
     ...
     */
    public <F extends WitnessArity<?>, A> Kind<F, A> requireNonNull(Kind<F, A> kind, Operation operation) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @throws NullPointerException if kind is null
     */
    public <F extends WitnessArity<?>, A> Kind<F, A> requireNonNull(Kind<F, A> kind, Operation operation, @Nullable String descriptor) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public <F extends WitnessArity<?>, A, B> void validateAp(Kind<F, ? extends Function<A, B>> ff, Kind<F, A> fa) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
