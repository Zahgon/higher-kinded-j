...
final class TupleGenerator {
    ...
    private static final String[] ORDINALS = { "First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Seventh", "Eighth", "Ninth", "Tenth", "Eleventh", "Twelfth" };

    private static final String[] ORDINAL_LOWER = { "first", "second", "third", "fourth", "fifth", "sixth", "seventh", "eighth", "ninth", "tenth", "eleventh", "twelfth" };

    private static final String[] MAP_OPS = { "MAP_FIRST", "MAP_SECOND", "MAP_THIRD", "MAP_FOURTH", "MAP_FIFTH", "MAP_SIXTH", "MAP_SEVENTH", "MAP_EIGHTH", "MAP_NINTH", "MAP_TENTH", "MAP_ELEVENTH", "MAP_TWELFTH" };
    ...
    private static void generateTuple(int n, ProcessingEnvironment processingEnv) throws IOException {
        ...
        // Javadoc
        sb.append("/**\n");
        sb.append(" * An immutable tuple containing ").append(n).append(" elements of potentially different types.\n");
        sb.append(" *\n");
        sb.append(" * <p>As a {@link java.lang.Record}, it automatically provides a canonical constructor,\n");
        sb.append(" * accessors (e.g., {@code _1()}, {@code _2()}), and implementations for {@code equals()},\n");
        sb.append(" * {@code hashCode()}, and {@code toString()}.\n");
        sb.append(" *\n");
        for (int i = 0; i < n; i++) {
            sb.append(" * @param <").append(TYPE_PARAMS[i]).append("> The type of the ").append(ORDINAL_LOWER[i]).append(" element.\n");
        }
        for (int i = 0; i < n; i++) {
            sb.append(" * @param _").append(i + 1).append(" The ").append(ORDINAL_LOWER[i]).append(" element of the tuple.\n");
        }
        sb.append(" */\n");
        ...
        sb.append("  private static final Class<").append(className).append("> ").append(constName).append(" = ").append(className).append(".class;\n\n");
    ...
    private static void generateBimap(StringBuilder sb, String constName) {
        sb.append("  /**\n");
        sb.append("   * Transforms both elements of this tuple using the provided mapping functions.\n");
        sb.append("   *\n");
        ...
        sb.append("      Function<? super A, ? extends C> firstMapper," + " Function<? super B, ? extends D> secondMapper) {\n");
    ...
    private static void generateMapAll(StringBuilder sb, int n, String className, String constName) {
        // Javadoc
        sb.append("  /**\n");
        sb.append("   * Transforms all ").append(n).append(" elements of this tuple using the provided mapping functions.\n");
        sb.append("   *\n");
        for (int i = 0; i < n; i++) {
            sb.append("   * @param ").append(ORDINAL_LOWER[i]).append("Mapper The non-null function to apply to the ").append(ORDINAL_LOWER[i]).append(" element.\n");
        }
        for (int i = 0; i < n; i++) {
            sb.append("   * @param <").append(TYPE_PARAMS[i]).append("2> The type of the ").append(ORDINAL_LOWER[i]).append(" element in the resulting tuple.\n");
        }
        ...
        sb.append("> map(\n");
        for (int i = 0; i < n; i++) {
            sb.append("      Function<? super ").append(TYPE_PARAMS[i]).append(", ? extends ").append(TYPE_PARAMS[i]).append("2> ").append(ORDINAL_LOWER[i]).append("Mapper");
            if (i < n - 1)
                sb.append(",\n");
        }
        sb.append(") {\n");
        // Validation
        for (int i = 0; i < n; i++) {
            sb.append("    Validation.function().require(").append(ORDINAL_LOWER[i]).append("Mapper, \"").append(ORDINAL_LOWER[i]).append("Mapper\", MAP);\n");
        }
        sb.append("\n");
        // Return
        sb.append("    return new ").append(className).append("<>(\n");
        for (int i = 0; i < n; i++) {
            sb.append("        ").append(ORDINAL_LOWER[i]).append("Mapper.apply(_").append(i + 1).append(")");
            if (i < n - 1)
                sb.append(",\n");
        }
        sb.append(");\n");
    ...
    private static void generateMapNth(StringBuilder sb, int n, int idx, String className, String constName) {
        ...
        sb.append("   *\n");
        sb.append("   * @param ").append(ordinalLower).append("Mapper The non-null function to apply to the ").append(ordinalLower).append(" element.\n");
        sb.append("   * @param <").append(typeParam).append("2> The type of the ").append(ordinalLower).append(" element in the resulting tuple.\n");
        sb.append("   * @return A new {@code ").append(className).append("} with the ").append(ordinalLower).append(" element transformed.\n");
        sb.append("   * @throws NullPointerException if {@code ").append(ordinalLower).append("Mapper} is null.\n");
        sb.append("   */\n");
        ...
        sb.append("> map").append(ordinal).append("(Function<? super ").append(typeParam).append(", ? extends ").append(typeParam).append("2> ").append(ordinalLower).append("Mapper) {\n");
        // Validation
        sb.append("    Validation.function().require(").append(ordinalLower).append("Mapper, \"").append(ordinalLower).append("Mapper\", ").append(mapOp).append(");\n");
        // Return
        sb.append("    return new ").append(className).append("<>(");
        for (int i = 0; i < n; i++) {
            if (i > 0)
