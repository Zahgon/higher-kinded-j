...
public class FoldProcessor extends AbstractProcessor {
    ...
    private void generateFoldsFile(TypeElement recordElement) throws IOException {
        ...
        JavaFile javaFile = JavaFile.builder(packageName, foldsClassBuilder.build()).addFileComment("Generated by hkj-optics-processor. Do not edit.").build();
    ...
    private MethodSpec createFoldMethod(RecordComponentElement component, TypeElement recordElement, TypeName recordTypeName) {
        ...
        ParameterizedTypeName foldTypeName = ParameterizedTypeName.get(ClassName.get(Fold.class), recordTypeName, targetType);
        MethodSpec.Builder methodBuilder = MethodSpec.methodBuilder(componentName).addJavadoc("Creates a {@link $T} for the {@code $L} field of a {@link $T}.\n\n" + "@return A non-null {@code Fold<$T, $T>}.", Fold.class, component.getSimpleName(), recordTypeName, recordTypeName, targetType).addModifiers(Modifier.PUBLIC, Modifier.STATIC).returns(foldTypeName);
