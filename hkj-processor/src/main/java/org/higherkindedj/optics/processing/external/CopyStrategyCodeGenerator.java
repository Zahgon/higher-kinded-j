...
public class CopyStrategyCodeGenerator {
     ...
     */
    public CodeBlock generateSetterLambda(CopyStrategyKind strategy, CopyStrategyInfo info, String fieldName, TypeMirror sourceType, TypeMirror focusType) {
     ...
     */
    private CodeBlock generateBuilderSetter(CopyStrategyInfo info, String fieldName, TypeMirror sourceType) {
        ...
        return CodeBlock.of("(source, newValue) -> source.$L().$L(newValue).$L()", toBuilder, setter, build);
    }
     ...
     * @return the code block
     */
    private CodeBlock generateConstructorSetter(CopyStrategyInfo info, String fieldName, TypeMirror sourceType) {
        ...
        return CodeBlock.of("(source, newValue) -> new $T($L)", sourceTypeName, constructorArgs.build());
    }
    ...
    private CodeBlock generateCopyAndSetSetter(CopyStrategyInfo info, TypeMirror sourceType) {
        ...
        if (!info.copyConstructor().isEmpty()) {
            ...
            return CodeBlock.of("(source, newValue) -> {\n" + "  $T copy = new $T(source);\n" + "  copy.$L(newValue);\n" + "  return copy;\n" + "}", sourceTypeName, sourceTypeName, setter);
        }
        return CodeBlock.of("(source, newValue) -> {\n" + "  $T copy = new $T(source);\n" + "  copy.$L(newValue);\n" + "  return copy;\n" + "}", sourceTypeName, sourceTypeName, setter);
    }
     ...
     * @return the generated code block for the getter lambda
     */
    public CodeBlock generateGetterLambda(String fieldName, CopyStrategyInfo info, TypeMirror sourceType) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
