...
public class ValidationController {
     ...
     */
    @PostMapping("/users")
    public Validated<List<ValidationError>, User> createUserWithValidation(@RequestBody CreateUserRequest request) {
     ...
     */
    public record ValidationBatchResult(String batchId, List<Validated<List<ValidationError>, User>> results) {
    }
}
