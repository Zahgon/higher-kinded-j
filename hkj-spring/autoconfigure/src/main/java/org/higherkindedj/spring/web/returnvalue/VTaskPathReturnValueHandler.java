...
public class VTaskPathReturnValueHandler implements AsyncHandlerMethodReturnValueHandler {
     ...
     */
    public VTaskPathReturnValueHandler(JsonMapper jsonMapper, int failureStatus, boolean includeExceptionDetails, long timeoutMillis, @Nullable HkjMetricsService metricsService) {
    ...
    private void writeFailureResponse(Throwable throwable, HttpServletResponse response) {
        try {
            ...
            if (includeExceptionDetails) {
                ...
                errorBody = Map.of("success", false, "error", "An error occurred during virtual thread execution");
            }
