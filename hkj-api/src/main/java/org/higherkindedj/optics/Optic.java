...
public interface Optic<S, T, A, B> {
     ...
     */
    <F extends WitnessArity<TypeArity.Unary>> Kind<F, T> modifyF(Function<A, Kind<F, B>> f, S s, Applicative<F> app);
     ...
     */
    default <C, U> Optic<C, U, A, B> dimap(Function<? super C, ? extends S> f, Function<? super T, ? extends U> g) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
