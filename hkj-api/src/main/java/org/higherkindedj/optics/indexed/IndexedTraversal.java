...
public interface IndexedTraversal<I, S, A> extends IndexedOptic<I, S, A> {
     ...
     */
    @Override
    <F extends WitnessArity<TypeArity.Unary>> Kind<F, S> imodifyF(BiFunction<I, A, Kind<F, A>> f, S source, Applicative<F> app);
     ...
     */
    default IndexedTraversal<I, S, A> filteredWithIndex(BiFunction<? super I, ? super A, Boolean> predicate) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
