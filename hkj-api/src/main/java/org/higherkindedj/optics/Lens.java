...
public interface Lens<S, A> extends Optic<S, S, A, A> {
     ...
     */
    <F extends WitnessArity<TypeArity.Unary>> Kind<F, S> modifyF(Function<A, Kind<F, A>> f, S source, Functor<F> functor);
     ...
     */
    static <S, A, B> Lens<S, Pair<A, B>> paired(Lens<S, A> first, Lens<S, B> second, Function3<S, A, B, S> reconstructor) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    static <S, A, B> Lens<S, Pair<A, B>> paired(Lens<S, A> first, Lens<S, B> second, BiFunction<A, B, S> constructor) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    default <F extends WitnessArity<TypeArity.Unary>> Kind<F, S> setIf(Predicate<? super A> predicate, A newValue, S source, Selective<F> selective) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    default <F extends WitnessArity<TypeArity.Unary>> Kind<F, S> modifyWhen(Predicate<? super A> shouldModify, Function<A, A> modifier, S source, Selective<F> selective) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    default <F extends WitnessArity<TypeArity.Unary>> Kind<F, S> modifyBranch(Predicate<? super A> predicate, Function<A, A> thenModifier, Function<A, A> elseModifier, S source, Selective<F> selective) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
