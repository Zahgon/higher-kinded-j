...
public abstract class BaseTraversableGenerator implements TraversableGenerator {
     ...
     */
    protected String generateConstructorArgs(final String changedComponent, final String newComponentValue, final List<? extends RecordComponentElement> allComponents) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
